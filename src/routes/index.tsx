  ...
  return (
    <AppShell title="Resumen" subtitle="Balance consolidado y liquidez">
      ...
      <div className="mt-4 grid gap-4 lg:grid-cols-2">
        <Card>
          <CardHeader className="pb-2">
            <CardTitle className="text-sm font-medium">Estado de Resultados - últimos 6 meses</CardTitle>
          </CardHeader>
      ...
      <div className="mt-4 grid gap-4 lg:grid-cols-2">
        <Card>
          <CardHeader className="pb-2">
            <CardTitle className="text-sm font-medium">Proyección de cuotas a vencer - próximos 6 meses</CardTitle>
          </CardHeader>
